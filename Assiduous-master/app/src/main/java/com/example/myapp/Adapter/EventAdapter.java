...
public class EventAdapter extends RecyclerView.Adapter<EventAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewholder, int position) {
        viewholder.eventText.setText(entityClasses.get(position).getEventname());
        viewholder.timeAndDateText.setText(entityClasses.get(position).getEventdate() + " " + entityClasses.get(position).getEventtime());
    }
